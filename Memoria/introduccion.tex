...
\begin{figure}[htb]
	\centering{\resizebox{3cm}{3cm}{\includegraphics{Jquery.png}}}
	\caption{Logo de JQuery}
\end{figure}
\FloatBarrier
...
Principalmente contiene funciones para manipular el DOM, realizar animaciones, gestionar eventos y desarrollar aplicaciones basadas en Ajax. Sus principales características son las siguientes:
\begin{itemize}  
...
\subsubsection {MySQL}
\begin{figure}[htb]
	\centering{\resizebox{3cm}{3cm}{\includegraphics{MySQL.png}}}
...
\begin{figure}[htb]
	\centering{\resizebox{3cm}{3cm}{\includegraphics{Brackets.png}}}
	\caption{Logo de Brackets}
\end{figure}
\FloatBarrier
...
\subsubsection {Git}
\begin{figure}[htb]
	\centering{\resizebox{3cm}{3cm}{\includegraphics{Git.png}}}
	\caption{Logo de Git}
\end{figure}
\FloatBarrier
...
\subsubsection {Bower}
\begin{figure}[htb]
	\centering{\resizebox{3cm}{3cm}{\includegraphics{Bower.png}}}
	\caption{Logo de Bower}
\end{figure}
\FloatBarrier
...
La forma más sencilla de instalar un nuevo paquete es buscar en internet el nombre del paquete que deseemos y posteriormente ejecutar en una consola de comandos \textit{bower install nombre\_paquete}. También es posible tener un archivo llamado bower.json en el que se guardan todas las dependencias de nuestro proyecto (con nombre de paquete y versión), de esta forma al ejecutar \textit{bower install}, se instalaran todos los paquetes de nuestro fichero, en la versión especificada. Es posible también utilizar sentencias condicionales en las versiones.
