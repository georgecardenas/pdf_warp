...
El tercer \textit{sprint} consta de cinco historias de usuario que se dividen en doce tareas, como está reflejado en el cuadro \ref{tab:sb03}. Al ser más largo y complejo que el resto, ya que se han realizado cambios en la funcionalidad general, se cuenta con un período de dos semanas para su realización.
...
Por otro lado se requiere una sección de administración para que un usuario con privilegios pueda gestionar plantillas. Se decide incluir una pestaña de administración dentro de la sección ``Appearance''. El diseño de las pantallas se puede ver en la figura \{***** incluir diseño de pantallas admin ****\}\\
...
\begin{itemize}
	...
	Como se puede observar, se incuyen librerías extra desde la carpeta \textit{vendor}. Estas librerías son para poder usar la extensión de AngularJs Draggabilly que nos permite mover elementos mediante \textit{drag and drop} al punto que queramos dentro de un elemento contenedor.\\
	...
	La página resultante se puede ver en la figura \{*******imagen edición plantilla *****\}
...
El último \textit{sprint} consta de seis historias de usuario que se dividen en doce tareas, como está reflejado en el cuadro \ref{tab:sb04}. Este \textit{sprint} aún siendo similar en tamaño al anterior, tiene menor complejidad ya que podemos reutilizar código y experiencia previa para realizar un desarrollo más ágil, por ello el tiempo estimado es de una semana.

\subsubsection{Diseño}
Lo único nuevo en cuestión de diseño en este \textit{sprint} es la pantalla de edición de plantillas de catálogos que podemos ver en la figura \{****** Diseño plantilla de catálogo******\}
...
\begin{itemize}
	...
	La página resultante se puede ver en la figura \{*******imagen edición plantilla catalogo *****\}
