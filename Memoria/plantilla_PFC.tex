...
\fancyhead[RE]{\color{blue}{Generación de catálogos en PDF para comercio electrónico}} % En las páginas pares, parte derecha del encabezado, aparecerá el título del proyecto
...
%
{\large {Generación de catálogos en PDF para comercio electrónico}}
...
\bibliographystyle{plain} \bibliography{librero}
